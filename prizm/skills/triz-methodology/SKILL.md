...
This skill is the shared methodology background for every subagent in the `prizm` plugin. It is a reference, not a runbook — each subagent's own system prompt tells it what to do; this skill explains the background it needs to do it well.
