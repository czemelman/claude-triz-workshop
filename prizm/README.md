...
- `/prizm:solve "<problem>"` - end-to-end pipeline.
- `/prizm:list` - list available matrices in the registry.
- `/prizm:explain <id>` - print a matrix card.
- `/prizm:replay <run-id>` - replay a previous run.
